...
class WalkRequestDetailsScreen
  ...
  Color _statusColor(
    ...
    switch (value.toLowerCase()) {
      ...
      case 'in_progress':
      case 'completed':
        return _WalkRequestDetailsColors
            .green;
